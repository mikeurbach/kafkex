defmodule Kafkex.Protocol.Fetch do
  ...
  defmodule Partition do
    ...
    def parse(
      ...
      {%Kafkex.Protocol.Fetch.Partition{
         partition: partition,
  ...
  defmodule TopicPartitions do
    ...
    def parse(
      ...
      {partitions, new_rest} =
        parse_list(partitions_length, rest, &Kafkex.Protocol.Fetch.Partition.parse/1)
  ...
  defmodule Request do
    ...
    def build(correlation_id, client_id, [topic_partitions: topic_partitions] = options) do
      ...
      topic_partitions_list =
        topic_partitions |> build_list(&Kafkex.Protocol.Fetch.TopicPartitions.build/1)
  ...
  defmodule Response do
    ...
    def parse(
          {:ok,
           <<correlation_id::32, throttle_time_ms::32, topic_partitions_length::32, rest::binary>>}
        ) do
      {topic_responses, <<>>} =
        parse_list(topic_partitions_length, rest, &Kafkex.Protocol.Fetch.TopicPartitions.parse/1)
